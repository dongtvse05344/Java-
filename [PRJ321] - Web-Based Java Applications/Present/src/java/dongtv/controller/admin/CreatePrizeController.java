...
public class CreatePrizeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.create(new PrizeDTO(0, name, description, null));
        } catch (Exception e) {
            log("ERROR at CreatePrizeController" +e.getMessage());
        }
        finally
        {
            request.getRequestDispatcher("Prize").forward(request, response);
        }
    }
