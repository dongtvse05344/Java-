...
public class ProductDAO implements Serializable {
    ...
    public List<ProductDTO> search(float a, float b) throws Exception {
        ...
        try {
            ...
            String sql = "SELECT ProductID,ProductName,ProductPrice,Description,Status FROM tbl_Product WHERE ProductPrice >= ? AND ProductPrice <= ?  AND Status = 'avaiable' ORDER BY ProductName  ";
