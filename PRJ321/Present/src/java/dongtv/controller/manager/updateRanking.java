 ...
 */
package dongtv.controller.manager;

import dongtv.bean.DongtvBean;
import static dongtv.controller.manager.Utils.RANKING;
 ...
 * @author xhunt
 */
public class updateRanking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (int i = 0; i < points.length; i++) {
                bean.setRankDTO(new RankDTO(usernames[i], eventId,Integer.parseInt(points[i]),0 ));
                bean.updatePoint();
            }
        } catch (Exception e) {
            log("ERROR at updateRanking " +e.getMessage());
        }
        finally
        {
