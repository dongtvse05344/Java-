...
public class Member extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = MEMBER_VIEW;
        try {
            session.setAttribute("TOOL", "Member");
            ...
            {
                 list = bean.getMembers(nameSearch);
            }
            //Paging 
            ...
            {
                index = Integer.parseInt(_count);
            }
            Page page = new Page(list,index,5);
            request.setAttribute("PAGE", page);
        } catch (Exception e) {
            log("Error at Member " +e.getMessage());
        }
        finally
        {
