        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-10 content">
                    ...
                    <div class="container">
                        <form action="UpdateEventController" method="POST" encType="multipart/form-data">
                            <input type="hidden" value="${requestScope.DTO.id}" name="eventId" />
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">                             
                                            <input type="hidden" id="banner" name="banner" value="${requestScope.DTO.banner}"/>
                                            <img id="example_img" src="${requestScope.DTO.banner}" width="200" height="120"/>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="managerId" class="custom-select mr-sm-2" >
                                                    <shuu:forEach var="dto" items="${sessionScope.list}">
                                                        <shuu:if test="${requestScope.DTO.managerId == dto.username}" var="check_manager">
                                                            <option selected value="${dto.username}" >${dto.name}</option>
                                                        </shuu:if>
                                                        <shuu:if test="${check_manager == false}">
                                    ...
                                    <input type="submit" name="action" value="Update Event" class="btn btn-primary"/>
        ...
        <script>
            function readURL(input) {
                if(input.files && input.files[0])
                {
                    ...
                    {
                        $('#example_img').attr('src',e.target.result);
                    }
